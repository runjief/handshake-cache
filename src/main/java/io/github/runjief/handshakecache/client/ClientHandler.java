package io.github.runjief.handshakecache.client;

import io.github.runjief.handshakecache.HandshakeCacheMod;
import io.github.runjief.handshakecache.cache.LocalRepository;
import io.github.runjief.handshakecache.packet.C2SHandshakeCacheLoginManifestAck;
...
@Mod.EventBusSubscriber(modid = HandshakeCacheMod.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
